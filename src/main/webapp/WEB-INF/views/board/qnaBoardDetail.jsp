...
<link rel="stylesheet" href="resources/css/qnaBoardDetail.css">
</head>
<body>
	<form action="qbdetail" method="post">
		<header>
			<h1>Q & A</h1>
		</header>
		<div id="div1">
			<table>
				...
				<tr height="30">
					...
					<td style="border: 1px solid #000033; border-radius: 5px;">${Detail.author}</td>
				</tr>
			</table>
			<div id="com_div">

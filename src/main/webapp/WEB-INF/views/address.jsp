...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(36.799167, 127.133306), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
...
var positions = [
	{ content:'<div>천안 캠퍼스</div>',  // 마커 롤오버시 표시할 내용
        latlng:new kakao.maps.LatLng(36.827655, 127.183389) },
    { content:'<div>아산 캠퍼스</div>',
        latlng:new kakao.maps.LatLng(36.73614259017708, 127.07436939936595) }, 
	];
